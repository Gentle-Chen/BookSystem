...
<html>
  ...
  <body>
	<form action="userAction1!update.action" method="post">
	<input type="hidden" name="id" value="${requestScope.user1.id }">
    <table id="tableForm">
      <tr>
        <td class="tdText">姓名:</td>
        <td class="tdInput">
          <input class="inputClass" type="text" name="name" value="${requestScope.user1.name}"/>
        </td>
      </tr>
      <tr>
        <td class="tdText">密码:</td>
        <td>
          <input class="inputClass" type="password" name="password" value="${requestScope.user1.password}"/>
        </td>
      </tr>
      <tr>
        <td class="tdText">年龄:</td>
        <td>
          <input class="inputClass" type="text" name="age" value="${requestScope.user1.age }" />
        </td>
      </tr>
      <tr>
        <td class="tdText">邮箱:</td>
        <td>
          <input class="inputClass" type="text" name="email" value="${requestScope.user1.email }" />
        </td>
      </tr>
