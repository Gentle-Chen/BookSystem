...
<header>
    ...
    <nav style="min-height: 130px;height:auto">
        <div align="center"><a href="index.jsp" target="_self"><img id="logopic" src="img/logo300x100.png"></a></div>
    </nav>
</header>
<div class="wrap">
...
//prev
    ...
    <div class="container">
        <div class="register-box">
            ...
            <form action="user_login.action" id="form1" style="width:80%;margin: 0 auto;display: block;" method="get" action="#">
                ...
                <div align="center" style="width:100%;font-size: 15px;margin-top: 10px">
                    <label style="padding: 0 10px">
                        <input type="radio" name="person" value="user">买家
                    </label>
                    <label style="padding: 0 10px">
            ...
            <form action="user_register.action" id="form2" style="width:80%;margin: 0 auto;display: none;" method="get" action="#">
                <div class="input-group" style="padding-top: 30px;">
                    <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
                    <input type="text" name="name" class="form-control" placeholder="用户名" style="height: 40px">
                </div>
                ...
                <div class="input-group" style="padding-top: 15px;">
                    <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
                    <input type="password" name="confirmpassword" class="form-control" placeholder="确认密码" style="height: 40px">
                </div>
                <div class="input-group" style="padding-top: 15px;">
                ...
                <div class="input-group" style="padding-top: 15px;">
                    ...
                    <input type="tel" name="telphone" class="form-control" placeholder="联系电话" style="height: 40px">
                </div>
                <div class="input-group" style="padding-top: 15px;">
