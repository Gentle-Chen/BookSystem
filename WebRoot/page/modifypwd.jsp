...
<header>
    <div class="greyheader">
        <span id="registericon" style="padding: 0 30px 0 2px;">
            <a href="nindexpage.jsp" target="_self">返回首页</a>
        </span>
        <%--<span>|</span>--%>
        <%--<span id="loginicon">--%>
    ...
    <nav style="min-height: 130px;height:auto">
        <div align="center"><a href="nindexpage.jsp" target="_self"><img id="logopic" src="../img/logo300x100.png"></a></div>
    </nav>
</header>
<div class="wrap">
    ...
    <div class="container">
        <div class="register-box">
            <div align="center"
                ...
                <div style="margin:0 auto;width: 165px;height:35px;line-height:35px;color: rgba(51,51,51,0.9);">修改密码</div>
            </div>
            <form id="form1" style="width:80%;margin: 0 auto;display: block;" method="post" action="#">
                <div class="input-group" style="padding-top: 30px;">
                    <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
                    <input type="text" name="username" class="form-control" placeholder="用户名" style="height: 40px">
                </div>
                <div class="input-group" style="padding-top: 30px;">
                    <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
                    <input type="password" name="oldpassword" class="form-control" placeholder="旧密码" style="height: 40px">
                </div>
                <div class="input-group" style="padding-top: 30px;">
                    <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
                    <input type="password" name="newpassword1" class="form-control" placeholder="新密码" style="height: 40px">
                </div>
                <div class="input-group" style="padding-top: 30px;">
                    <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
                    <input type="password" name="newpassword2" class="form-control" placeholder="确认密码" style="height: 40px">
                </div>
                <span style="margin: 0 auto;"><button type="submit" class="btn btn-primary"
                                                      style="text-align:center;width: 100%;margin-top: 20px">确认修改</button></span>
            </form>
